  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-gray-100">
      <div className="bg-white w-full max-w-md border border-gray-200 p-6 rounded-lg">
        <h1 className="text-2xl text-gray-900 font-bold text-center mb-4 font-serif">Register</h1>
        <div>
    {
    ...
    <form onSubmit={handleSubmit} className="space-y-3 ">
        ...
        <button className="w-full bg-blue-500 text-white py-2 rounded-md hover:bg-blue-600 transition duration-200 cursor-pointer">Register</button>
    </form>
        </div>
      </div>
